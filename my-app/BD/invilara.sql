...
--
-- Host: 127.0.0.1    Database: invilara
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '6fa20c8f-ae2e-11f1-9181-c8f750265387:1-1880';
...
CREATE TABLE `avance` (
  ...
  KEY `fk_avance_obra1_idx` (`obra_id_obra`,`obra_estado`,`obra_contratacion_id_contratacion`,`obra_gestionar_proyectos_codigo_proyecto`),
  KEY `fk_avance_empleado1_idx` (`gerente`)
...
INSERT INTO `comunidad` VALUES (1,'Manzanita','Rural','Manzanita',2,1),(2,'carorita','cuji','la playa',4,1),(3,'hskHJS','ihjdsk','hjajda',5,1),(4,'Nuevo Horizonte','San Francisco','Oeste',6,1),(5,'Cauderales 1','Consejo Comunal','Cauderales',23,1),(6,'Gato Negro','Rural','Rastrojitos',24,1),(7,'Bellas Artes','Urbano','Av. Ribereña con distribuidor bellas Artes',25,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de contrataciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contratacion` VALUES (1,'Se contratan los servicios de la empresa Construcciones Racelca para la remoción y sustitución vial.','Construcciones Racelca','INV-OB-001','BS 4.562.716,00','2026-09-15 00:00:00','2026-09-18 00:00:00','Contrato de Obra','Concurso Abierto','Ejecución de Obras','Contrato sujeto a cambios','2026-09-16 00:00:00','J-74438453',1);
...
INSERT INTO `empresa` VALUES ('12','Polar','04122212121','Calle 13c',0,0),('J-714712571','Empresa Pereira','0414-5125412','Calle 14, Sector Centro',1,1),('J-74438453','Construcciones Racelca','0424-9831936','Prolongacion Av. Los Leones, Torre Bel, piso 9, Of. 2A',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de informes de avances de obras';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inspeccion` (
  ...
  KEY `fk_inspeccion_obra1_idx` (`obra_id_obra1`,`obra_estado1`,`obra_contratacion_id_contratacion1`,`obra_gestionar_proyectos_codigo_proyecto1`),
  KEY `fk_inspeccion_evidencia1_idx` (`evidencia_id_evidencia`),
  KEY `fk_inspeccion_empleado1_idx` (`inspector`)
...
INSERT INTO `inspeccion` VALUES (1,6,'2026-09-17','Inicial','Se observo que la zona aledaña al sitio de la obra presenta irregularidades en cuanto a la estabilidad del suelo por eso primero recomendamos nivelar el suelo antes de proceder a la colocación de la carpeta asfáltica.',26,3,1,'PRY-001',26,3,1,'PRY-001',30,1);
...
INSERT INTO `institucion` VALUES (2,'María Rodríguez','U.E.N. Lisandro Alvarado',16,1);
...
CREATE TABLE `obra` (
  ...
  `ubicacion_obra` text NOT NULL,
  `periodo_ejecucion` varchar(10) NOT NULL,
  `fecha_inicio` date NOT NULL,
  `fecha_fin` date NOT NULL,
  `mediciones_obra` varchar(100) NOT NULL,
  `valuaciones` varchar(100) NOT NULL,
  `modificaciones_contrato` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`id_obra`,`estado`,`contratacion_id_contratacion`,`gestionar_proyectos_codigo_proyecto`),
  UNIQUE KEY `id_obra_UNIQUE` (`id_obra`),
  KEY `fk_obra_semaforo1_idx` (`estado`),
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de las inspecciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `obra` VALUES (26,'REHABILITACION DEL DISTRIBUIDOR BELLAS ARTES','AV. RIBEREÑA','3 SEMANAS','2026-09-17','2026-10-07','500 ton asfalto','13.723.319,93','N/A',0,'INV-OB-001',27,3,1,'PRY-001',1);
...
INSERT INTO `particular` VALUES (1,'Gabriel','Mujica',1,1),(2,'Mariangel','Bokor',11,1),(3,'Guillermo','Torres',18,1),(4,'Susana','Torres',21,1),(5,'Raiza Lisseth','Chirinos Sanchez',22,1),(6,'Francisco Hurtado','Perez Mejias',23,1);
...
INSERT INTO `persona` VALUES (1,29957469,'Calle 24 entre 32 y 33','Catedral','Iribarren','04128280586','gabrielenriquemch@gmail.com',1),(2,34567896,'prueba','Agua Viva','Palavecino','04245678568','fedegtq2@gmail.com',1),(3,56785729,'calle miami','Hilario Luna y Luna','Morán','04245678934','youtube@gmail.coom',1),(4,31258936,'cuji','Freitez','Crespo','04245087200','redfiury21@gmail.com',1),(5,30088284,'ihjdsk','Cabudare','Palavecino','04120587814','jose@gmail.com',1),(6,28433546,'San Francisco','Guerrera Ana Soto (Juan de Villegas)','Iribarren','04123582233','mafer25@gmail.com',1),(7,29345267,'Calle 52 con Carrera 24 y 25 ','Iribarren','Guerrera Ana Soto','04123456420','Juan45p@gmail.com',1),(9,7833562,'Carrera 24 entre Calles 36 y 37','Iribarren','Juan de Villegas','04248379835','Cesif67@gmail.com',1),(10,30587785,'Carrera 4 con Calle 5','Cabudare','Palavecino','04245319088','bokorMBmariposa@gmail.com',1),(11,8977634,'Av. Los Horcones con Av. La Salle.','Catedral','Iribarren','04125677474','MejiAlejandro443@gmail.com',1),(12,28542148,'Calle 9 entre Cra. 20 y 21, Casa N° 20-15','Concepción','Iribarren','04163347465','Elenaita22Ri@gmail.com',1),(13,29723582,'Urb. La Rosaleda, Calle 5, Casa 12','Cabudare','Palavecino','04125543568','ElJavivi@gmail.com',1),(14,29545867,'Av. Los Abogados, Res. El Parque, Torre A','Santa Rosa','Iribarren','04146564722','LaSofi23@gmail.com',1),(15,12345678,'Av. Principal, Sector Centro','Catedral','Iribarren','0251-2319786','contacto@l-alvarado.edu.ve',1),(16,25289197,'Calle Carabobo, Casa N° 34','Anzoátegui','Morán','04120896778','FranVier@gmail.com',1),(17,28342778,'Calle 5 con Carrera 6','Freitez','Crespo','04127766654','Guille@gmail.com',1),(18,28456734,'Urb. Sucre, Avenida 27 con calle 30, Casa #15','Catedral','Iribarren','04121234567','maria.perez@ejemplo.com',1),(19,22345678,'Urb. Valle Hondo, Calle 3, Quinta La Perla','Cabudare','Palavecino','04129876543','CarlosGomezIng@gmail.com',1),(20,29057934,'Calle 5 con carrera 6B','Cabudare','Palavecino','04128763478','Susanita@gmail.com',1),(21,9543017,'Calle 24 entre carreras 32 y 33 N° 32-48','Catedral','Iribarren','04145265983','raizachirinos@gmail.com',1),(22,12228342,'Calle Zamora N° 10','Pío Tamayo','Andrés Eloy Blanco','04148837728','franmejias@gmail.com',1),(23,7182274,'Consejo Comunal','Siquisique','Urdaneta','0416-6911314','ramonfelipej@gmail.com',1),(24,17478142,'Rural','Morán','Morán','0424-5130057','danielacarrasco@gmail.com',1),(25,7941123,'Urbano','Cabudare','Palavecino','0426-3392213','urbellasartes@gmail.com',1);
...
INSERT INTO `prioridad` VALUES (1,0.3,NULL,NULL,'manual','2026-06-15 16:38:02','admin','La comunidad no tiene acceso a servicios básicos de agua, lo que representa un problema de seguridad',1),(2,0.7,'Obra Mayor','Baja','ia','2026-09-02 01:23:47','Test','Prueba',1),(3,0.7,'Obra Mayor','Baja','ia','2026-09-02 01:24:56','Test','No hay necesidad de intervención urgente en este caso, ya que el problema es un simple ',1),(4,0.3,'Obra Mayor','Alta','ia','2026-09-02 01:25:42','Test','La solicitud corresponde a una obra mayor debido a la naturaleza de los servicios básicos (agua, luz',1),(5,0,'Obra Mayor','Alta','ia','2026-09-02 01:25:46','Test','Necesidad de vacunación en la comunidad para proteger la salud y la asistencia médica',1),(6,0,'Obra Mayor','Alta','ia','2026-09-02 01:25:50','Test','La magnitud del problema corresponde a una ',1),(7,0,'Obra Mayor','Alta','ia','2026-09-02 01:25:54','Test','Reconstrucción de carreteras y pavimentación de vías principales',1),(8,0.7,'Obra Mayor','Baja','ia','2026-09-02 01:25:59','Test','La solicitud corresponde a una mejora de servicios básicos en la ciudad de Santa Ana, Venezuela.',1),(9,0.15,'Obra Mayor','Alta','ia','2026-09-02 01:26:05','Test','Riesgo inminente a personas y infraestructura crítica debido a la naturaleza del bacheo y las filtra',1),(10,0.3,'Obra Mayor','Alta','ia','2026-09-02 01:26:09','Test','Solicitación de vacunación en todo el estado Lara, Venezuela.',1),(11,0.7,'Obra Mayor','Baja','ia','2026-09-02 01:26:15','Test','La comunidad no tiene acceso a servicios básicos de agua, lo que representa un problema de seguridad',1);
...
CREATE TABLE `proyecto` (
  ...
  KEY `fk_proyecto_empleado1_idx` (`proyecto_has_empleado`)
...
INSERT INTO `proyecto` VALUES ('PRY-001','2026-09-15 16:29:05','Se plantea la demolición de miembros de concreto armado con equipo liviano (compresor) base de junta, para anclar la nueva junta a colocar.\r\nPara la rehabilitación de la vía se plantea la colocación puntual de asfalto, así como la remoción y sustitución de la cubre junta deteriorada por el desgaste, la demarcación con línea continua en pavimento con material reflectivo (pintura de trafico reflectiva aplicada en frio, ancho = 14 cm) y la colocación de marcadores reflectivos bidireccionales, tipo ojos de gato lo cual mejorara la visibilidad en la vía.','[{\"metrica\":\"m3\",\"opcion\":\"TRANSPORTE EN CAMIONES, A DISTANCIAS MAYORES DE 200 M., DE CUALQUIER TIPO DE MATERIAL PROVENIENTE DE LA PREPARACIÓN DEL SITIO (AGREGADO Y/O BOTE); POR TERRENO PLANO EN CARRETERA PAVIMENTADA\",\"costo\":\"194.78\"},{\"metrica\":\"m2\",\"opcion\":\"RIEGO DE ADHERENCIA EMPLEANDO MATERIAL ASFALTICO TIPO RC-250, INCLUYENDO LOS MATERIALES\",\"costo\":\"33.94\"},{\"metrica\":\"m2\",\"opcion\":\"LIMPIEZA DE MALEZA Y VEGETACIÓN BAJA CON ALTURA INFERIOR A 1.5 MT. (DESMALEZADORA)\",\"costo\":\"100\"},{\"metrica\":\"kg\",\"opcion\":\"COLOCACION DE MEZCLA ASFALTICA EN CALIENTE TIPO IV (PARA BACHEO HASTA 30 M2)\",\"costo\":\"11750\"}]','BS 4.562.716,00',8,0);
...
INSERT INTO `proyecto_has_maquinaria` VALUES ('FRE-001',7,1),('PRY-001',16,1),('PRY-001',19,1),('PRY-001',20,1),('PRY-001',23,1),('PRY-001',25,1),('PRY-005',20,1),('PRY-005',25,1),('PRY-009',16,1),('PRY-009',24,1),('PRY-009',25,1),('PRY-010',23,1),('PRY-010',24,1),('PRY-010',25,1),('WEY-001',16,1);
...
INSERT INTO `proyecto_has_solicitudes` VALUES ('PRY-001',9,1,1,1);
...
INSERT INTO `publicacion` VALUES (1,'Cabudares esta en escaces de agua por varias semanas','Administrador','General','2026-07-07 00:55:59',2,'Gracias a las orientaciones del gobernador Cmdte. Luis Reyes Reyes, seguimos activos y avanzando con el despliegue estrategico para la reconstrucción y sustitución de las estructuras de alcantarillas en diferentes sectores de la parroquia Cabudare del municipio Palavecino, Estado Lara.',1),(2,'Gran Avance de la Rehabilitación de la obra de Santa Elena','Administrador','General','2026-09-16 18:26:39',57,'Se logro un gran avance en la obra de Santa Elena, pudiendo reparar casi en su totalidad la falla de borde.',1);
...
INSERT INTO `semaforo` VALUES (1,'Por Culminar','VERDE','Por Culminar',1),(2,'En progreso','AMARILLO','En progreso',1),(3,'Paralizada','ROJO','Paralizada',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla general de las solicitudes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitudes` VALUES (1,'2026-09-08 09:38:02','Particular','Completada','[Servicios Básicos (Agua, Luz, Gas)] no hay gas',1,4,1),(2,'2026-09-08 10:12:32','Comunidad','Completada','[Salud y Asistencia Médica] En la comunidad necesitamos una jornada de vacunación',2,5,1),(3,'2026-09-08 15:46:00','Comunidad','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] hueco en la avenida donde salen aguas negras',4,6,1),(4,'2026-09-09 08:58:23','Comunidad','En Proceso','[Infraestructura y Vialidad] Acondicionamiento vial',6,7,1),(5,'2026-09-09 13:04:42','Particular','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] A una de las torres de alta tension que se encuentran alrededor de la comunidad, se le cayo uno de los cables, ocasionando graves daños al tejado de una vivienda',11,8,1),(6,'2026-09-11 08:33:39','Institucion','En Proceso','[Infraestructura y Vialidad] Reparación de bacheo profundo en el acceso principal de la institución por filtraciones.',16,9,1),(7,'2026-09-11 09:07:35','Particular','Pendiente','[Salud y Asistencia Médica] Se necesita una jornada de vacunacion en el sector Piedras Lindas',18,10,1),(8,'2026-09-15 10:12:59','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] En la comunidad no hay agua debido a una rotura de la tuberia que conecta al sector con la tuberia principal',21,11,1),(9,'2026-09-15 12:27:42','Particular','En Proceso','[Infraestructura y Vialidad] Dadas las condiciones en las cuales se encuentra actualmente la vialidad, se hace necesaria la ejecución de los trabajos que a continuación se describen: Realizar limpieza de vegetación, remoción de pavimento y construcción de muro de gaviones',1,1,1),(10,'2026-09-15 13:41:44','Comunidad','Pendiente','[Vivienda] Solicito la dotacion de un tanque de 1000 litros para mi vivienda, debido a que el anterior quedo inutilizable',23,1,1),(11,'2026-09-15 15:09:27','Comunidad','Pendiente','[Otros] Se solicita la reconstrucción de alcantarilla en la entrada de la comunidad Gato Negro, la cual se encuentra en malas condiciones, además, parte de la misma se encuentra sobresaliendo de la vía.',24,1,1),(12,'2026-09-15 15:51:20','Comunidad','Pendiente','[Otros] Se solicita la reparacion de las aceras de la comunidad encontrandose las mismas en condiciones deterioradas.',25,1,1);
...
-- Dump completed on 2026-09-16 19:16:49

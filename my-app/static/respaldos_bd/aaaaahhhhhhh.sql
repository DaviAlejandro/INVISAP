...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '6fa20c8f-ae2e-11f1-9181-c8f750265387:1-919';
...
INSERT INTO `empresa` VALUES ('12','Polar','04122212121','Calle 13c',0,0),('J-714712571','Empresa Pereira','0414-5125412','Calle 14, Sector Centro',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de informes de avances de obras';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de las inspecciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `obra` VALUES (25,'Obra de Cabudares','Carrera 7A con calles 6 y 5','3 meses','2026-06-02','2026-09-18','4 mts cuadrados','Valuaciones N°1 - Bs. 50.000','maquinas usadas por las empresas contratadas',4,'INV-OB-001',47,2,2,'WEY-001',1);
...
INSERT INTO `particular` VALUES (1,'Gabriel','Mujica',1,1),(2,'Mariangel','Bokor',11,1),(3,'Guillermo','Torres',18,1),(4,'Susana','Torres',21,1);
...
INSERT INTO `proyecto` VALUES ('FRE-001','2026-06-24 00:00:00','Restauración Vial','230 m2','200000 dolares',NULL,0),('WEY-001','2026-07-01 00:00:00','Servicio Basico ','11513424m2','237523',NULL,1);
...
INSERT INTO `proyecto_has_maquinaria` VALUES ('FRE-001',7,1),('WEY-001',16,1);
...
INSERT INTO `proyecto_has_solicitudes` VALUES ('FRE-001',7,6,1,1),('WEY-001',8,11,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla general de las solicitudes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitudes` VALUES (1,'2026-06-15 16:38:02','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] no hay gaz de prueba mortadela',1,4,1),(2,'2026-06-15 16:40:32','Comunidad','Completada','[Salud y Asistencia Médica] En la comunidad necesitamos una jornada de vacunación',2,5,1),(3,'2026-06-15 16:46:00','Comunidad','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] hueco en la avenida donde salen aguas negras',4,6,1),(7,'2026-06-16 17:58:23','Comunidad','En Proceso','[Infraestructura y Vialidad] Acondicionamiento vial',6,7,1),(8,'2026-06-24 16:04:42','Particular','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] No hay agua y todos nos estamos derritiendo, porfis traigan aguita aaaaaaaaa',11,8,1),(9,'2026-07-05 22:32:39','Institucion','En Proceso','[Infraestructura y Vialidad] Reparación de bacheo profundo en el acceso principal de la institución por filtraciones.',16,9,1),(10,'2026-07-07 19:59:35','Particular','En Proceso','[Salud y Asistencia Médica] Se necesita una jornada de vacunacion',18,10,1),(11,'2026-08-17 00:55:59','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] En la comunidad no hay agua',21,11,1),(12,'2026-09-12 18:50:42','Particular','Pendiente','[Infraestructura y Vialidad] La acumulación de deuda técnica en los sistemas de software actual representa un gran riesgo para las empresas. Cuando los desarrolladores priorizan la velocidad de entrega de código por encima de la calidad estructural, se generan dependencias frágiles y cuellos de botella irreparables que dificultan enormemente el mantenimiento. Esta negligencia incrementa dramáticamente los costos de operación, multiplica los errores en el código, frustrando al talento humano y colapsando toda la arquitectura de negocio.',1,1,1);
...
-- Dump completed on 2026-09-12 22:51:15
